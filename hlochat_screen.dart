...
import 'package:hloapp_1/presentation/pages/sub_pages/select_contact_page.dart';
import 'package:hloapp_1/presentation/pages/sub_pages/single_communication_page.dart';
import 'package:hloapp_1/presentation/pages/sub_pages/single_item_chat_user_page.dart';
...
class HloChat extends StatefulWidget {
  ...
  const HloChat({Key key, this.userInfo}) : super(key: key);
